...
const Question = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 text-center text-white max-w-3xl mx-auto pt-32 px-6">
        ...
        <p className="text-sm mb-8 animate__animated animate__fadeIn animate__delay-2s">
          You’ve brought so much joy, laughter, and meaning to my life. I can’t imagine a day without you. 
