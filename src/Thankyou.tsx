...
const ThankYou = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center">
      ...
      {/* Content Wrapper */}
      <div className="relative z-20 max-w-lg w-full text-center p-8 rounded-xl shadow-2xl ">
        ...
        <p className="text-xl text-pink-300  mb-6 animate__animated animate__fadeIn animate__delay-2s">
          You’ve made me the happiest person today. I promise to cherish, support, Loyal and make every moment 
          with you special.
        </p>
        ...
        {/* Message Box */}
        <div className="mb-8 mx-auto max-w-md  p-6 rounded-lg shadow-lg bg-opacity-90 backdrop-blur-xl">
          <h2 className="text-2xl font-semibold text-center mb-4 text-gray-200">Your Message</h2>
          <textarea
